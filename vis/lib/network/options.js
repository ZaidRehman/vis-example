...
let allOptions = {
  ...
  nodes: {
    ...
    shape: { string: ['ellipse', 'circle', 'database', 'box', 'text', 'image', 'circularImage', 'diamond', 'dot', 'star', 'triangle', 'triangleDown', 'square', 'icon', 'hexagon','dialog'] },
    shapeProperties: {
...
let configureOptions = {
  nodes: {
    ...
    shape: ['ellipse', 'box', 'circle', 'database', 'diamond', 'dot', 'square', 'star', 'text', 'triangle', 'triangleDown','hexagon','dialog'],
    shapeProperties: {
      borderDashes: false,
